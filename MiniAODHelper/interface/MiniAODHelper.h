...
class MiniAODHelper{
 ...
 public:
  ...
  virtual std::vector<pat::Muon> GetSelectedMuons(const std::vector<pat::Muon>&, const float, const muonID::muonID, const coneSize::coneSize = coneSize::R03, const corrType::corrType = corrType::rhoEA, const float = 2.4);
